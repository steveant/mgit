...
class ConfigurationManager:
    ...
    def get_provider_config(self, name: str) -> Dict[str, Any]:
        ...
        if name not in providers:
            ...
            raise ValueError(f"Provider configuration '{name}' not found. Available: {available}")
    ...
    def get_default_provider_config(self) -> Dict[str, Any]:
        ...
        if not default_name:
            ...
            if providers:
                ...
                logger.warning(f"No default provider set, using first available: {default_name}")
            else:
    ...
    def detect_provider_type(self, provider_name: str) -> str:
        ...
        if 'org_url' in config and 'pat' in config:
            ...
            raise ValueError(f"Cannot detect provider type for '{provider_name}'. Configuration keys: {list(config.keys())}")
