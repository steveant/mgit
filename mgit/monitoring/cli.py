...
if TYPER_AVAILABLE:
    monitoring_app = typer.Typer(
        name="monitoring",
        help="mgit monitoring and observability commands"
    )
else:
    monitoring_app = None
...
def _ensure_typer():
    ...
    if not TYPER_AVAILABLE:
        print("Error: typer is required for CLI commands. Install with: pip install typer")
        sys.exit(1)
...
if TYPER_AVAILABLE:
    ...
    def metrics_cmd(
        format_type: str = typer.Option("prometheus", "--format", "-f", help="Output format"),
