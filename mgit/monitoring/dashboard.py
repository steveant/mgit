...
def create_grafana_dashboard(
    datasource_name: str = "Prometheus", refresh_interval: str = "30s"
) -> Dict[str, Any]:
        ...
        "dashboard": {
            ...
            "panels": [
                ...
                # Operation Duration Percentiles
                {
                    ...
                    "yAxes": [{"label": "Duration (seconds)", "min": 0}],
                ...
                # Authentication Success Rate
                {
                    ...
                    "yAxes": [{"label": "Success Rate (%)", "min": 0, "max": 100}],
                ...
                # Authentication Attempts
                {
                    ...
                    "yAxes": [{"label": "Attempts/sec", "min": 0}],
                    ...
                    "rules": [
                        {
                            ...
                            "for": "1m",
                            "labels": {"severity": "critical", "service": "mgit"},
                            "annotations": {
                        ...
                        },
                        {
                            ...
                            "for": "5m",
                            "labels": {"severity": "warning", "service": "mgit"},
                            "annotations": {
                    ...
                    "rules": [
                        {
                            ...
                            "for": "1m",
                            "labels": {"severity": "info", "service": "mgit"},
                            "annotations": {
...
def save_dashboard_config(dashboard_config: Dict[str, Any], output_path: Path) -> None:
...
def save_alert_rules(alert_rules: List[Dict[str, Any]], output_path: Path) -> None:
...
def create_monitoring_configuration(
    output_dir: Path, datasource_name: str = "Prometheus", namespace: str = "mgit"
) -> None:
