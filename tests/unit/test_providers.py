...
class TestBitbucketProvider:
    ...
    def test_bitbucket_workspace_repositories(self, bitbucket_provider):
        ...
        # Mock repository response
        mock_repos = [
            {"slug": "repo1", "links": {"clone": [{"href": "https://bitbucket.org/test-workspace/repo1.git"}]}},
            {"slug": "repo2", "links": {"clone": [{"href": "https://bitbucket.org/test-workspace/repo2.git"}]}},
        ]
...
class TestProviderAuthentication:
    ...
    @pytest.mark.parametrize("provider_type,auth_config", [
...
class TestProviderURLHandling:
    ...
    def test_normalize_repository_urls(self):
        ...
        test_cases = [
            # Azure DevOps
            ("https://dev.azure.com/org/_git/repo", "https://dev.azure.com/org/_git/repo"),
            ("https://org@dev.azure.com/org/_git/repo", "https://dev.azure.com/org/_git/repo"),
        ...
        test_cases = [
            {
                ...
                "expected": {"provider": "azure", "org": "myorg", "project": "myproject", "repo": "myrepo"}
            },
            {
            ...
            },
            {
                ...
                "expected": {"provider": "bitbucket", "workspace": "myworkspace", "repo": "myrepo"}
            },
        ]
